...
This directory contains the review catalogs exported from the modern Adiscon User Interface project. The catalogs are review artifacts; the corresponding Adiscon User Interface `.resw` files remain the source of truth.
...
The metadata file describes the 4 modern product hosts and the supported locales. Catalog paths in the metadata are relative to this directory.
